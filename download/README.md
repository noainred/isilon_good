...
| 버전 | 호환 | tar.gz | zip |
|------|------|--------|-----|
| **1.7.1** (latest) | Python 3.6+ | [tar.gz](https://github.com/noainred/isilon_good/raw/claude/upbeat-bell-cXX8f/download/isilon_usage-1.7.1.tar.gz) (108 KB) | [zip](https://github.com/noainred/isilon_good/raw/claude/upbeat-bell-cXX8f/download/isilon_usage-1.7.1.zip) |
