...
| 버전 | 호환 | tar.gz | zip |
|------|------|--------|-----|
| **1.32.1** (latest) | Python 3.6+ | [tar.gz](https://github.com/noainred/isilon_good/raw/claude/upbeat-bell-cXX8f/download/isilon_usage-1.32.1.tar.gz) (226 KB) | [zip](https://github.com/noainred/isilon_good/raw/claude/upbeat-bell-cXX8f/download/isilon_usage-1.32.1.zip) |
